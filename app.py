...
<style>
*{box-sizing:border-box} body{margin:0;background:transparent;color:#e5e7eb;font-family:Inter,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif}.shell{background:linear-gradient(180deg,#101827,#090d17);border:1px solid rgba(255,255,255,.09);border-radius:22px;padding:14px;box-shadow:0 20px 70px rgba(0,0,0,.32)}.top{display:grid;grid-template-columns:auto auto auto 1fr auto auto;align-items:center;gap:8px;margin-bottom:10px}.play{width:44px;height:44px;border-radius:50%;border:0;background:linear-gradient(135deg,#7c3aed,#06b6d4);color:white;font-size:17px;font-weight:900;cursor:pointer}.btn{height:32px;border-radius:10px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.06);color:#dbeafe;font-weight:850;font-size:12px;cursor:pointer}.btn.active{background:#22d3ee;color:#06111c}.title{font-weight:850;letter-spacing:-.03em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;padding-left:5px}.time{font:800 12px ui-monospace,Menlo,monospace;color:#9ca3af}.speed,.master{height:32px;border-radius:10px;background:#111827;color:#e5e7eb;border:1px solid rgba(255,255,255,.1);font-weight:750}.master{width:96px;accent-color:#22d3ee}.wave-card{position:relative;background:rgba(255,255,255,.035);border:1px solid rgba(255,255,255,.07);border-radius:16px;padding:10px 12px;margin-bottom:8px}.hint{font:700 11px ui-monospace,Menlo,monospace;color:#94a3b8;margin-top:5px}.mixer{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin:8px 0 10px}.track{display:grid;grid-template-columns:1fr auto auto;gap:6px;align-items:center;padding:8px;border-radius:13px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.065)}.track-name{font-weight:850;font-size:13px;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.tog{height:24px;width:28px;border:0;border-radius:7px;background:#1f2937;color:#9ca3af;font-weight:900;font-size:11px;cursor:pointer}.tog.m.active{background:#ef4444;color:white}.tog.s.active{background:#facc15;color:#111827}.vol{grid-column:1/4;width:100%;accent-color:var(--c);height:4px}.score{position:relative;background:#fffdf6;color:#111827;border-radius:18px;border:1px solid #d7cfbd;padding:14px;max-height:460px;overflow:auto}.score-head{display:flex;justify-content:space-between;align-items:center;font:800 11px ui-monospace,Menlo,monospace;color:#746b5a;margin-bottom:8px}.bargrid{display:grid;grid-template-columns:repeat(8,1fr);gap:5px;margin-top:9px}.barcell{position:relative;border:1px solid #ded6c4;border-radius:9px;padding:7px;text-align:center;background:#fffaf0;transition:.12s}.barcell.active{background:#dbeafe;border-color:#2563eb;box-shadow:inset 0 0 0 2px #2563eb}.barcell.active:before{content:"";position:absolute;top:-7px;bottom:-7px;left:50%;width:2px;background:#ef4444}.barno{font:800 10px ui-monospace,Menlo,monospace;color:#8a806c}.ch{font-size:18px;font-weight:950;color:#111827}.rt{font-size:10px;color:#6b7280}.conf{font-size:9px;color:#9ca3af}.presets{display:flex;gap:6px;flex-wrap:wrap;margin-top:7px}@media(max-width:820px){.top{grid-template-columns:auto auto auto 1fr}.mixer{grid-template-columns:1fr 1fr}.bargrid{grid-template-columns:repeat(4,1fr)}.master,.speed{width:80px}.title{grid-column:1/5}}
...
const ws = window.WaveSurfer.create({container:'#wave', url:DATA.mix, waveColor:'#334155', progressColor:'#22d3ee', cursorColor:'#ef4444', cursorWidth:2, height:82, barWidth:2, barGap:1, barRadius:2, normalize:true, plugins:[regions]});
...
ws.on('timeupdate', t=>{ $('cur').textContent=fmt(t); syncStemTime(t); updateBar(t); if(loopOn&&activeRegion&&t>=activeRegion.end) seekAll(activeRegion.start,true); });
...
buildMixer(); applyMix();
ABCJS.renderAbc('score', DATA.abc, {responsive:'resize', staffwidth:920, paddingtop:0, paddingbottom:0});
